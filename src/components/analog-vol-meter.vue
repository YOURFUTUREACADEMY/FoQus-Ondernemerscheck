...
<template>
    ...
    <svg 
        ...
        viewBox="0 0 1000 500" version="1.1" 
        ...
        <g transform="matrix(0.638978,0,0,0.638978,179.232,32.0619)">
            ...
            <g transform="matrix(1.99996,0.0121471,-0.00884282,1.53075,-684.187,-209.3)">
                <g id="circelwijzer">
                    <g id="arrow">
            ...
            <g id="binnencirkel" transform="matrix(0.0371459,0,0,0.0380883,166.419,264.478)">
            ...
            <g id="Onderkant" transform="matrix(1.56285,0,0,1.60471,-280.825,-195.917)">
...
export default {
  ...
  methods: {
    runMeter(){
        ...
        document.getElementById("arrow").style.transform = `rotate(${this.meter.pointerDeg}deg)`;
      }
  },
// end export  
};
