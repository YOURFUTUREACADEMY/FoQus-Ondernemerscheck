...
const opmerkingen = {
  ...
  conclusies:{
    ...
    conclusie2:[
      // [0]: Placeholder voor logica
      'C2.0 - conclusie 2 waarde is 0',
      // [1]: Conclusie 2.0 | 4 >0,5 AND 6 daalt of gelijk | oranje
      `lijkt dat je te weinig aan innovatie en verbetering doet. Kijk eens kritisch naar interne processen en marktontwikkelingen, en probeer je producten/diensten en interne processen aan te passen aan de snel veranderende marktomstandigheden en de technologische vooruitgang.`,
